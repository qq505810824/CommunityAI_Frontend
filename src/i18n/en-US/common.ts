const translation = {
    ...
    account: {
        ...
        langGeniusAccount: 'DocAI account',
    ...
    members: {
        ...
        invitationSentTip:
            'Invitation sent, and they can sign in to DocAI to access your team data.',
    ...
    provider: {
        ...
        openaiHosted: {
            ...
            desc: 'The OpenAI hosting service provided by DocAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
    ...
    apiBasedExtension: {
        title: "API extensions provide centralized API management, simplifying configuration for easy use across DocAI's applications.",
    ...
    common: {
        confirmTitle: 'Confirmation', // 新增翻譯
        confirmContent: 'Are you sure you want to delete this item?' // 新增翻譯
    }
};
