            ...
            <div className="w-full justify-center flex flex-col items-center">
                ...
                {data && (
                    <div className="w-[680px] overflow-hidden  px-4">
                        <h1 className="article-title text-black text-2xl sm:text-4xl font-bold">{data.title}</h1>
                        ...
                        <div className="my-4  ">
                            <div className="text-md  " dangerouslySetInnerHTML={{ __html: data.description }} style={{ whiteSpace: 'pre-wrap' }} />
                        </div>
                    </div>
                )}
            </div>
