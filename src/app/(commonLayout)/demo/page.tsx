...
const newsItems = [
    {
        ...
        content:
            '华为今日发布新一代旗舰手机，采用自研芯片，搭载最新鸿蒙操作系统，在AI性能方面有显著提升。新机型在影像系统和续航能力上都有重大突破。',
    ...
    },
    {
        ...
        content:
            '特斯拉公司宣布推出革命性的新一代电动汽车平台，预计将使生产成本降低50%，有望推动电动汽车更快普及。',
        image: 'https://inews.gtimg.com/om_bt/OI3LImU5YxrF3pt2ofq3oPeWPRbEbt9kptUky4H0RXjTEAA/641',
        date: '2024-03-18'
    },
    {
        ...
        content:
            'OpenAI正式发布GPT-5模型，在多个领域的表现已接近人类水平，特别是在逻辑推理和创造性任务方面取得重大突破。',
        image: 'https://inews.gtimg.com/om_bt/OI3LImU5YxrF3pt2ofq3oPeWPRbEbt9kptUky4H0RXjTEAA/641',
        date: '2024-03-15'
    }
];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900">
            ...
            <main className="pt-16">
                ...
                {/* News Section */}
                <section id="news" className="py-20 bg-gray-900/50 backdrop-blur-lg">
