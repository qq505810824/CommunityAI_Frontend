...
const HomePage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            ...
            {/* 使用独立的 Header 组件 */}
            <Header />
            <div className="relative h-[80vh] overflow-hidden pt-16"> {/* 添加 pt-16 以避免内容被 AppBar 遮挡 */}
                <Image
                    src="https://inews.gtimg.com/news_ls/OKRhIS575ludai32yi1aiVsly7FlM67BgP4JHjzwNW2XgAA_870492/0"
                    alt="科技背景"
                    layout="fill"
                    objectFit="cover"
                />
                <div className="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-center">
                    <Fade in={true} timeout={1000}>
                        <div style={{ transform: 'scale(0.5)', opacity: 0, animation: 'scaleIn 1s forwards' }}>
                            {/* 在手机端减小标题字体大小 */}
                            <Typography level="h2" sx={{ color: 'white', fontWeight: 'bold', marginBottom: 4 }}>
                                创新科技，引领未来
                            </Typography>
                            {/* 在手机端减小副标题字体大小 */}
                            <Typography level="body-md" sx={{ color: 'white', fontWeight: 'bold', marginBottom: 4 }}>
                ...
                <div className="absolute bottom-0 left-0 right-0 z-10"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" preserveAspectRatio="none" className="w-full h-16 md:h-24"><path fill="#f3f4f6" fill-opacity="1" d="M0,32L48,37.3C96,43,192,53,288,53.3C384,53,480,43,576,53.3C672,64,768,96,864,106.7C960,117,1056,107,1152,90.7C1248,75,1344,53,1392,42.7L1440,32L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg></div>
                <style jsx>{`
                    @keyframes scaleIn {
                        from {
                            transform: scale(0.5);
                    ...
                    <div className='w-full mx-auto py-16 px-4'>
                        ...
                        <div className='flex flex-row mt-8 flex-wrap items-center'>
                            <div className='flex-1'>
                                <img src='https://www.hkjsse.org/_next/image?url=%2Fassets%2Fimages%2Fcover.jpg&w=3840&q=75&dpl=dpl_CeyNzWBVywSzJcxQzS7MouXLZhDp'
                            ...
                            <div className='  ml-4 flex flex-row flex-wrap  flex-0 sm:flex-1    '>
                                <span className='text-xl text-left'>
                                    香港聯校科學展覽交流協會（HKJSSE）是一個由歷屆香港聯校科學展覽的學生領袖組成的平台，致力推動香港的 STEAM 教育發展，並促進校際及跨地區的科學交流。
                                </span>
                            </div>
                        </div>
                    </div>
