import CampaignItem from '@/app/components/admin/campaigns/CampaignItem';
...
function CampaignView(props: ViewProps) {
    ...
    return (
        <React.Fragment>
            <div className="w-full flex justify-between items-center my-4">
                <Typography level="h3">Campaign 列表</Typography>
                {/* <Button
                    variant="solid"
                    color="primary"
                ...
                <TableSheet>
                    <thead>
                        <tr>
                            ...
                            <th className="text-center w-[60px]">状态</th>
                            <th className="text-center w-[60px]">地点</th>
                            <th className="text-center w-[60px]">日期</th>
                            <th className="text-center w-[60px]">人数</th>
