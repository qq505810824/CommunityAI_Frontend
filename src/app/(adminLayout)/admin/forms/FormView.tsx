...
import { EventForm } from './FormContainer';
interface ViewProps {
    isLoading: any;
    products: EventForm[];
    handleSearch: any;
        ...
        <React.Fragment>
            ...
            <div className="w-full overflow-x-scroll">
                ...
                <TableSheet>
                    <thead>
                        <tr>
                            <th className="text-center w-[150px]">名稱</th>
                            <th className="text-center w-[200px]">描述</th>
                            {/* <th className="text-center w-[60px]">狀態</th> */}
                            <th className="text-center whitespace-nowrap w-[100px]">創建时间</th>
