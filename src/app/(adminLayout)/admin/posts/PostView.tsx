import PostItem from '@/app/components/admin/posts/PostItem';
...
function PostView(props: ViewProps) {
    ...
    return (
        <React.Fragment>
            <div className="w-full flex justify-between items-center my-4">
                <Typography level="h3">Post 列表</Typography>
                {/* <Button
                    variant="solid"
                    color="primary"
                ...
                <TableSheet>
                    <thead>
                        <tr>
                            ...
                            <th className="text-center w-[60px]">channel</th>
                            <th className="text-center w-[60px]">comments</th>
