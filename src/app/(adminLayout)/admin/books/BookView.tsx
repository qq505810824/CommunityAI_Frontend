import BookItem from '@/app/components/admin/books/BookItem';
...
function BookView(props: ViewProps) {
                ...
                <TableSheet>
                    <thead>
                        <tr>
                            ...
                            <th className="text-center w-[60px]">分類</th>
                            <th className="text-center w-[60px]">價格</th>
                            <th className="text-center whitespace-nowrap w-[60px]">是否免費</th>
                            <th className="text-center w-[60px]">作者</th>
                            <th className="text-center whitespace-nowrap w-[100px]">出版社</th>
