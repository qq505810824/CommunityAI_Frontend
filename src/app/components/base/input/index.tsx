...
const Input = ({
    ...
    return (
        <div className={`relative inline-flex w-full flex-col ${wrapperClassName}`}>
            {displayName && (
                <div className="mb-1">
            ...
            <div>
                {showPrefix && (
                    <span className={s.prefix}>
                        {prefixIcon ?? (
                            <GlassIcon className="h-3.5 w-3.5 stroke-current text-gray-700 stroke-2" />
                        )}
                    </span>
                )}
                ...
                <input
                    ...
                    placeholder={
                        placeholder ??
                        (showPrefix ? t('common.operation.search') ?? '' : 'please input')
                    }
                    value={value}
                    onChange={(e) => {
