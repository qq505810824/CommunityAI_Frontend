...
export default function FilterView(props: ViewProps) {
    ...
    return (
        <>
            <div className="w-full items-center bg-blue-400 text-center px-4 flex flex-col justify-center py-10 sm:py-20  ">
                <Typography level="h2" sx={{ color: '#eeeeee', marginBottom: 4 }} >Prompt</Typography>
                <SearchInputView
            ...
            <div className="w-full sm:max-w-7xl  px-4   flex my-2 flex-row  justify-start items-start ">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-row gap-2 flex-wrap items-center">
                        ...
                        {secondOptions.map((tag, index) => (
                            <TagView key={index} tag={tag} onSelect={() => {
                    ...
                    <div className="flex flex-row gap-2 flex-wrap items-center">
                        ...
                        {selectOption && <TagView tag={selectOption} onDelete={() => {
                            setSelectedOption("")
                        }}></TagView>}
