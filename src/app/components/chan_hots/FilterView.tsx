...
export default function FilterView(props: ViewProps) {
    ...
    return (
        <>
            <div className="w-full sm:max-w-7xl flex flex-col  justify-start items-start space-y-0 mb-8 ">
                <div className="w-full flex flex-row items-center  space-x-2 whitespace-nowrap hidden">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex flex-row gap-2  items-center">
                        <div className="flex flex-row gap-2 flex-wrap items-center">
                            ...
                            <button
                                className={`  hover:bg-gold-500  text-sm  px-4 py-2 rounded-lg font-medium ${selectFather?.name == '' ? 'bg-gold-400 text-gray-900 ' : 'bg-gray-600 hover:bg-gray-500 text-white'}`}
                                onClick={() => {
                                    setSelectedFather({
                                        name: ''
                                    });
                            ...
                            {categorys?.map((tag, index) => (
                                <button
                                    key={index}
                                    className={`  hover:bg-gold-500 text-sm   px-4 py-2 rounded-lg font-medium ${selectFather?.name == tag.cat_name ? 'bg-gold-400 text-gray-900 ' : 'bg-gray-600 hover:bg-gray-500 text-white'}`}
                                    onClick={() => {
                                        setSelectedFather({
                                            name: tag.cat_name
                                        });
