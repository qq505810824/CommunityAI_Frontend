import { faPaperPlane, faRobot, faShield } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className="flex justify-start">
                        <div className="bg-gray-700 rounded-lg p-3 max-w-xs">
                            <p className="text-white text-sm">
                                Hi John! Looking forward to our meeting next week. I have some
                    ...
                    <div className="flex justify-end">
                        <div className="bg-gold-400 rounded-lg p-3 max-w-xs">
                            <p className="text-gray-900 text-sm">
                                Absolutely! I'm excited to hear about them. Would Tuesday at 2 PM
                                work for you?
                            </p>
                    ...
                    <div className="flex justify-start">
                        <div className="bg-blue-600 rounded-lg p-3 max-w-xs">
                            <p className="text-white text-sm">
                                ...
                                AI Suggestion: Consider introducing Sarah to Marcus Rodriguez - high
                                synergy potential in fintech investments.
                            </p>
                ...
                <div className="p-4 border-t border-gray-700">
                    <div className="flex space-x-2">
                        <input
                            ...
                            className="flex-1 bg-gray-700 text-white rounded- lg px-4 py-2 text-base focus:outline-none focus:ring-2 focus:ring-gold-400"
                        />
