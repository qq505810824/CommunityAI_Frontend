...
import { useJoinCommunityData, useMyCommunityData } from '@/hooks/useCommunityData';
...
export default function DashbordContainer() {
    ...
    const { data: MyCommunityData, mutate: mymutate } = useMyCommunityData({ user_id: user_id });
